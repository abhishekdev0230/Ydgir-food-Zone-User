...
ThemeData dark = ThemeData(
  fontFamily: AppConstants.fontFamily,
  primaryColor: const Color(0xFFFFC906), // 🔥 updated
  secondaryHeaderColor: const Color(0x9BFFC906), // 🔥 updated
  disabledColor: const Color(0xffa2a7ad),
  brightness: Brightness.dark,
  hintColor: const Color(0xFF5E6472),
  cardColor: const Color(0xFF141313),
  ...
  textButtonTheme: TextButtonThemeData(
    style: TextButton.styleFrom(foregroundColor: const Color(0xFFFFC906)), // 🔥 updated
  ),
  colorScheme: const ColorScheme.dark(
    primary: Color(0xFFFFC906), // 🔥 updated
    tertiary: Color(0xff6165D7),
    tertiaryContainer: Color(0xff171DB6),
    secondary: Color(0x9BFFC906), // 🔥 updated
  ).copyWith(
